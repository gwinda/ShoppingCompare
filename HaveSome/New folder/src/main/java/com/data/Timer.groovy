...
public class Timmer {
    ...
    public static void main(String[] args) {
        ...
        t.schedule(tt, date, 10000);    // Starting from the current time, per  1 Second to repeatedly perform a scheduled task, I only used here is the current time  , Time can according to their needs.  .
